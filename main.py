...
async def cmd_start(message: types.Message, bot_instance: Bot = bot):
    ...
    if message.from_user.id == MY_ID:
        ...
        activation_text = f"""
<b>⚡ Добро пожаловать, {message.from_user.full_name}! NFT Roulett - лучшая рулетка подарков в Телеграм!
Данный бот дает возможность получить множество нфт-подарков. Крути спины, радуй себя хорошими подарками. Испытай свою удачу в этом боте, удачи!🩷</b>
